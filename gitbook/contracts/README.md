...
Current hardened deployment, redeployed after fixing 4 critical + 7 high internal-audit findings. These supersede all earlier testnet addresses. All four addresses confirmed live on-chain — deployed June 7, 2026, **re-verified on-chain on August 30, 2026 at block 46,164,700**.

| Contract | Address |
|----------|---------|
| SUWP token (ERC-20, 18 decimals, 1,000,000 supply) | [`0x0b96a41a2a4c9b50097049d24f43848be3A892e8`](https://sepolia.basescan.org/address/0x0b96a41a2a4c9b50097049d24f43848be3A892e8) |
...
Explorer **source verification is not yet published** for the three Suwappu-authored contracts (bytecode is live and behavior-verified; publishing matching source is a pre-mainnet task). The GDA pool is a verified `SuperfluidPool` beacon proxy. Creation transactions and the deployer address are listed in the machine-readable snapshot linked below.
