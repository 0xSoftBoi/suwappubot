...
For network/5xx failures on managed execution:
...
Source and deeper adapter examples: [`0xSoftBoi/suwappu-langchain`](https://github.com/0xSoftBoi/suwappu-langchain).
