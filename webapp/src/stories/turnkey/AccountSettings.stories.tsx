        ...
        <div className={`absolute top-0 right-0 h-full w-72 bg-white shadow-xl z-20 transform transition-transform duration-300 ${isOpen ? 'translate-x-0' : 'translate-x-full'}`}>
          ...
          <div className="p-4 space-y-6 overflow-y-auto h-[calc(100%-60px)]">
            ...
            <div>
              ...
              <div className="space-y-2">
                <button className="w-full flex items-center gap-3 p-3 bg-linear-to-r from-suwappu-purple/10 to-suwappu-magenta-mid/10 rounded-suwappu-lg border border-suwappu-purple/20 hover:border-suwappu-purple/50 transition-colors">
  ...
  render: () => (
    <div className="flex gap-3">
      <button className="flex flex-col items-center gap-2 p-4 bg-white rounded-suwappu-xl shadow-suwappu-2 border border-suwappu-sakura-mid/20 hover:shadow-suwappu-3 hover:-translate-y-0.5 transition-all w-24">
        <div className="w-12 h-12 bg-linear-to-br from-suwappu-sakura-light to-suwappu-rose rounded-suwappu-lg flex items-center justify-center">
      ...
      <button className="flex flex-col items-center gap-2 p-4 bg-white rounded-suwappu-xl shadow-suwappu-2 border border-suwappu-sakura-mid/20 hover:shadow-suwappu-3 hover:-translate-y-0.5 transition-all w-24">
        <div className="w-12 h-12 bg-linear-to-br from-suwappu-cyan to-suwappu-blue rounded-suwappu-lg flex items-center justify-center">
      ...
      <button className="flex flex-col items-center gap-2 p-4 bg-white rounded-suwappu-xl shadow-suwappu-2 border border-suwappu-sakura-mid/20 hover:shadow-suwappu-3 hover:-translate-y-0.5 transition-all w-24">
        <div className="w-12 h-12 bg-linear-to-br from-suwappu-success to-green-400 rounded-suwappu-lg flex items-center justify-center">
