...
export function parseErrorCode(error: Error | string | unknown): ErrorCode {
  const message = typeof error === 'string' ? error.toLowerCase() : error instanceof Error ? error.message.toLowerCase() : ''
