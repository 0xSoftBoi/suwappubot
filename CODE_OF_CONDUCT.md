...
- Soliciting funds, promoting tokens, shilling, or posting referral links in
...
reported to the maintainers at **conduct@suwappu.bot**. All complaints will be
...
2. **Warning** — A warning with consequences for continued behavior, including
   no interaction with those involved for a specified period of time.
