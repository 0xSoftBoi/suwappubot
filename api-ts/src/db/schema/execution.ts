...
export const executionIntents = pgTable(
	'execution_intents',
	{
		...
		amountMode: varchar('amount_mode', { length: 24 }),
		...
		quantityAsset: varchar('quantity_asset', { length: 128 }),
...
export const executionParentOrders = pgTable(
	...
	(table) => ({
		...
		sourceRefUnique: uniqueIndex('uq_exec_parent_source_ref').on(table.sourceType, table.sourceRef),
...
export const executionFills = pgTable(
	'execution_fills',
	{
		...
		priceAsset: varchar('price_asset', { length: 128 }),
		inputAsset: varchar('input_asset', { length: 128 }),
		inputAmount: varchar('input_amount', { length: 78 }),
		outputAsset: varchar('output_asset', { length: 128 }),
		outputAmount: varchar('output_amount', { length: 78 }),
