...
/// first auxiliary-provisioning proof are implemented, but `Pi_mod`, `Pi_fac`,
/// and malicious presigning proofs are not. There is deliberately no public
/// way to manufacture a presignature.
