...
class CustodialTransaction(Base):
    ...
    # Client-supplied idempotency key for withdraw dedupe (unique index added
    # via database/db.py _ensure_schema migration; NULLs allowed for
    # non-withdrawal transaction types that don't supply one).
