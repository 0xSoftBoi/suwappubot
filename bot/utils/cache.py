...
class AsyncCache:
    """Simple async-compatible in-memory cache with TTL."""
...
price_cache = AsyncCache(default_ttl=30)  # 30 second TTL for prices
quote_cache = AsyncCache(default_ttl=15)  # 15 second TTL for quotes
balance_cache = AsyncCache(default_ttl=60)  # 60 second TTL for balances
gas_cache = AsyncCache(default_ttl=15)  # 15 second TTL for gas prices
