...
metrics_wallets_handler = CallbackQueryHandler(
    metrics_wallets_callback, pattern="^metrics_wallets$"
)
metrics_errors_handler = CallbackQueryHandler(metrics_errors_callback, pattern="^metrics_errors$")
metrics_refresh_handler = CallbackQueryHandler(
    metrics_refresh_callback, pattern="^metrics_refresh$"
)
