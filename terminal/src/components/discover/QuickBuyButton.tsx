...
export function QuickBuyButton({ tokenSymbol, tokenAddress, onBuy }: QuickBuyButtonProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="px-2 py-0.5 text-[10px] font-semibold rounded bg-sakura-600/20 text-sakura-400 border border-sakura-600/30 hover:bg-sakura-600/30 transition-colors"
      >
        Buy
      </button>
