...
import { TerminalChainBadge, TerminalDeltaText } from '../foundation/TerminalDataDisplay'
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0">
        ...
        <div className="mt-1 truncate text-xs text-terminal-text-secondary">{token.name}</div>
      </div>

      <div className="text-right">
        <div className="text-xs text-terminal-text-muted">Price</div>
        <div className="mt-1 font-mono text-sm text-terminal-text">
          {loading ? (
