...
const EVENT_TYPE_OPTIONS = [
  ...
  { value: 'approval_expired', label: 'Approval expired' },
  { value: 'killswitch_triggered', label: 'Killswitch triggered' },
]
...
function VerifyBadge() {
  const { data, isLoading } = useAuditVerify(1000)
          ...
          <div className="p-4">
            <TerminalPanel>
              <TerminalEmptyState
                ...
                description="Try again in a moment, or narrow your filters."
              />
            </TerminalPanel>
          </div>
        ) : events.length === 0 ? (
