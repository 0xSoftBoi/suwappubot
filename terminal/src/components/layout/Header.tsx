...
export function Header() {
  ...
  if (isMobile) {
    return (
      <header className="relative flex items-center justify-between h-12 px-3 border-b border-terminal-border bg-terminal-panel shrink-0">
        ...
        {menuOpen && (
          <div className="absolute top-12 left-0 right-0 z-50 bg-terminal-bg-secondary border-b border-terminal-border p-3 flex flex-col gap-3">
