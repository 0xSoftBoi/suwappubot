  ...
  return (
    <div className="flex flex-wrap items-center gap-1.5">
      ...
      <div className="flex min-w-0 flex-1 flex-wrap gap-1">
        {PRESETS.map((preset) => (
          <button
            ...
            className={joinClasses(
              "terminal-mobile-touch terminal-theme-control tnum min-h-[32px] min-w-[56px] px-2.5 py-1 font-mono text-[11px] transition-colors hover:translate-y-0 focus:translate-y-0 active:scale-[0.98]",
              !custom && value === preset
        ...
        <label
          className={joinClasses(
            "terminal-mobile-touch terminal-theme-control relative flex min-h-[32px] min-w-[72px] flex-1 items-center px-2.5 hover:translate-y-0 focus-within:translate-y-0",
            custom
              ? "terminal-theme-control-active text-terminal-text"
