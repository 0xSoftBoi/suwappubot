...
export type BottomTab = 'portfolio' | 'signals' | 'discovery' | 'watchlist' | 'copy-trading' | 'wallet-tracker' | 'tweets' | 'defi' | 'curve' | 'lido' | 'aave' | 'balancer' | 'compound' | 'uniswap' | 'pancakeswap' | 'morpho' | 'euler' | 'yearn' | 'copilot' | 'referrals' | 'rewards' | 'intel' | 'approvals' | 'audit' | 'data'
