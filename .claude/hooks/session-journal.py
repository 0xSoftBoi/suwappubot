...
docs/harness/self-improving.md). Every session appends exactly one compact
JSON record to .claude/harness/journal/YYYY-MM.jsonl capturing friction
signals (tool errors, permission denials, retries). The /evolve skill mines
these records to decide what to fix in the harness itself.
