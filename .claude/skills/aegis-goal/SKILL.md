...
- [ ] 3.4 (Phase-3 follow-up, not in first PR) Outbound sanitization: schema-validate/filter the MPP directory passthrough (`mcp.ts:570` — currently returned verbatim to agents) and scrub reflected free-text in the A2A unknown-command echo (`a2a.ts:338`).
