        ...
        <main className="docs-page__main">
          <motion.div {...reveal(0)}>
            ...
            <p className="section__body" style={{ marginBottom: '2.5rem' }}>
              The cross-chain DeFi API built for AI agents. Register an agent, get best-price
              quotes, and execute swaps, perps, and gasless trades across {stats.platformChains}{' '}
              chains from one REST API, a TypeScript SDK, and an MCP server.
            </p>
