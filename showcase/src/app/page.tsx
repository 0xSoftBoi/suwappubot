...
const STEPS = [
  {
    ...
    description:
      'Open @suwappu_bot in Telegram. A non-custodial wallet is created for you automatically — no seed phrase to write down.',
    icon: (
...
const FAQ_ITEMS = [
  ...
  { q: 'Do I need to install anything?', a: 'No. The Telegram and WhatsApp bots work in-app \u2014 just search @suwappu_bot. The Mini App runs inside Telegram too. Only the iOS app requires a download.' },
