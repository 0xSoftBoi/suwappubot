          ...
          <section id="build" className="summer-devlayer" aria-label="Build with Suwappu">
            ...
            <div className="summer-devlayer__grid">
              ...
              >
                ...
                <p>Drop into Claude Code, Codex, Cursor, or any MCP host. Nothing to install.</p>
                <p className="summer-devlayer__pointer">
                  <a href="#agents">Copy the setup brief</a> and paste it into your agent.
                </p>
              </article>
