...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: { path: string; priority: number; freq: MetadataRoute.Sitemap[number]['changeFrequency'] }[] = [
    ...
    { path: '/solutions/trading-agents', priority: 0.7, freq: 'monthly' },
    { path: '/solutions/portfolio-agents', priority: 0.7, freq: 'monthly' },
    { path: '/solutions/agent-payments', priority: 0.7, freq: 'monthly' },
    { path: '/solutions/embedded-wallets', priority: 0.7, freq: 'monthly' },
