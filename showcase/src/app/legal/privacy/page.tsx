    ...
    <main id="main-content" className="summer-page docs-shell">
      ...
      <div className="summer-shell mkt-page">
        <article className="legal-page">
          ...
          <p>We use data to execute and settle your requests, prevent abuse and fraud, enforce limits and rate-limiting, provide support, and improve the Service. <strong>We do not sell data that identifies you as an individual.</strong> We may create, use, share, and license aggregated and anonymized data that does not identify you, as described in Section 5.</p>
          ...
          <h2>5. Aggregated &amp; anonymized data</h2>
          <p>We may produce aggregated and anonymized datasets and statistics derived from activity on the Service — for example, total or net swap volumes, route choices, fee economics, and trading patterns by chain, token, or time period. Before this information leaves our systems it is stripped of account and personal identifiers (such as Telegram, WhatsApp, and Discord IDs, usernames, wallet addresses, transaction hashes, and IP addresses) and is aggregated so that no individual user, wallet, or transaction can be identified or re-identified, including by combining it with other data we make available. Small groups that could single out an individual are suppressed. Because this information does not identify you, it is not personal data, and we may use, share, license, or sell it — including to analytics, research, index, and AI providers. <strong>We will never sell, license, or share data that identifies you as an individual, your wallet addresses, your private keys, or your individual transactions.</strong></p>
          ...
          <p>You may request access to, correction of, or deletion of personal data we hold about you, subject to legal limits and the immutable nature of on-chain data. You may also ask us to exclude your activity from future aggregated datasets. Contact us using the details below.</p>
