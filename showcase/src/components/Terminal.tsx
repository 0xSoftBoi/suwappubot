...
export default function Terminal() {
  ...
  return (
    <div
      className="terminal rounded-2xl overflow-hidden shadow-suwappu-card border border-white/5"
      aria-label="Interactive terminal demo showing Suwappu bot conversation"
    >
      {/* Title bar */}
      <div className="flex items-center gap-2 px-4 py-3 border-b border-white/5" aria-hidden="true">
      ...
      {/* Content */}
      <div
        className="p-5 min-h-[280px] text-[13px] leading-relaxed space-y-0.5"
        role="log"
        aria-live="polite"
