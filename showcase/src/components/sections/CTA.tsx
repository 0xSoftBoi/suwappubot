    ...
    <section className="py-24 px-6 relative overflow-hidden" id="cta">
      ...
      <div className="max-w-3xl mx-auto relative z-10" ref={ref}>
        ...
        >
          ...
          <p className="font-body text-lg md:text-xl text-white/90 mb-10 max-w-xl mx-auto">
            Join thousands of traders swapping tokens across chains — directly from Telegram.
          </p>
          ...
          <motion.div
            ...
            className="mt-10 flex flex-wrap justify-center gap-8 text-white/70"
          >
